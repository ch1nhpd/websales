...
<?php
	...
	if (isset($_POST['dangky'])) {
		...
		$run_query = mysqli_query($conn, "INSERT INTO khachhang VALUES ('$mskh', '$ten_khach_hang', '$dia_chi', '$dien_thoai', '$tai_khoan', '$mat_khau');");
		if ($run_query) {
    ...
    <main class="login-main">
        <div class="container login-main__inner">
            <div class="login-main__logo">
                ...
                <h1>Xiaomi</h1>
                <p><span>Nền tảng thương mại điện tử</span> hàng đầu ở Đông Nam Á</p>
            </div>
            <div class="login-main__form">
                <form action="" method="POST" enctype="multipart/form-date" class="form" id="form-1" onsubmit="return signup()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address" id="address" placeholder="VD: Nam Định" class="form-control" />
                    ...
                    <p class="notice">Nếu bạn đã có tài khoản - <a href="login.php">Đăng nhập</a></p>
                </form>
            </div>
        </div>
    </main>
