<?php
    ...
    $query_chitiet = mysqli_query($conn, "SELECT * FROM hanghoa, nhomhanghoa WHERE hanghoa.MaNhom = nhomhanghoa.MaNhom AND hanghoa.MSHH ='$_GET[id]';");
    $row_chitiet = mysqli_fetch_array($query_chitiet);
?>
<div class="main-detail" id="main-detail">
    <p class="main-detail__link">
        <a href="index.php">Trang chủ</a>/<a href="index.php?xem=chitietloaisanpham&id=<?php echo $row_chitiet['MaNhom'] ?>#line"><?php echo $row_chitiet['TenNhom'] ?></a>/ <a href="#main-detail"><?php echo $row_chitiet['TenHH'] ?></a>
    </p>
    <p class="main-detail__name">
        <?php echo $row_chitiet['TenHH'] ?><span>(<?php echo $row_chitiet['MSHH'] ?>)</span>
    </p>
