<?php
	...
	$run = mysqli_query($conn, "SELECT * FROM chitietdathang, dathang WHERE chitietdathang.SoDonHH = dathang.SoDonHH AND dathang.TrangThai = 'false' ORDER BY chitietdathang.GiaDatHang ASC;");
?>
