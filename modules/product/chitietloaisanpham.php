<?php
    ...
    $query_chitiet = mysqli_query($conn, "SELECT * FROM hanghoa WHERE MaNhom = '$_GET[id]' LIMIT $trang_1, 6;");
    mysqli_close($conn);
?>
<?php
    include 'admincp/modules/config.php';
    ...
    $query_temp = mysqli_query($conn, "SELECT * FROM hanghoa WHERE MaNhom = '$_GET[id]' LIMIT $trang_1, 6;");
