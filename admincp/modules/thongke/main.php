        ...
        <table class="main__form-table center">
            ...
            <?php
                if (isset($_POST['tim'])) {
                    ...
                    $sql = "SELECT SUM(GiaDatHang) FROM dathang, chitietdathang, khachhang WHERE dathang.SoDonHH = chitietdathang.SoDonHH AND dathang.MSKH = khachhang.MSKH AND (khachhang.HoTenKH = '$_POST[name]' or khachhang.taikhoan = '$_POST[name]');";
