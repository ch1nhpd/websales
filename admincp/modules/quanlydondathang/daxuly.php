<?php
	...
	$run = mysqli_query($conn, "SELECT * FROM dathang WHERE TrangThai = 'true' ORDER BY NgayDH ASC;");
?>
<p class="main__content-title">Quản lý đơn đặt hàng <span>/</span> Danh sách đơn đặt hàng đã xử lý</p>
